...
-- Equivalente CLI-tracked: supabase/migrations/20260622190143_partner_applications.sql
...
-- GRANT explicito: RLS controla linhas, GRANT controla acesso a tabela via Data API
-- (ver db/migrations/0002_grant_data_api_access.up.sql).
